      ...
      describe Base do
        ...
        describe '#search' do
          ...
          context 'with scopes' do
            before do
              Person.stub :ransackable_scopes => [:active, :over_age, :of_age, :between_age]
            end
            ...
            it "applies arrays scopes" do
              s = Person.ransack('between_age' => [18, 19, 20])
              s.result.to_sql.should include "\"age\" IN (18, 19, 20)"
            end
