module Ransack
  module ActiveRecord
    # Extended onto ActiveRecord::Base: the `ransack` entry point, the
    # `ransacker` and `ransack_alias` declarations, and the allowlist methods
    # every model must define before it can be searched.
    module Base
