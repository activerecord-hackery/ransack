  ...
  module ActiveRecord
    ...
    class Context < ::Ransack::Context
      ...
      def build_joins(relation)
        ...
        join_dependency = JoinDependency.new(relation.klass, relation.table, association_joins, Arel::Nodes::OuterJoin)
...
Ransack::Context.register do |object, options|
  ...
  when ::ActiveRecord::Relation
    Ransack::ActiveRecord::Context.new(object.klass, options)
  end
end
